...
const TravellerBooking = () => {
  ...
  return (
    <div>
      ...
      <div className="search-container" style={{ width: "100%",backgroundColor:'#B4ADAB' }}>
        <div className="container" style={{ width: "100%",backgroundColor:'#B4ADAB' }}>
          <form className="form-group" >
            ...
            <div className="search-button" >
              <button style={{backgroundColor:'black'}} onClick={(e) => { handleSearch(e) }}>Search</button>
            </div>
          </form>
        </div>
      </div>
