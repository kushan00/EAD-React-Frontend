...
import { updateSchedule, getScheduleByID } from "../../services/ScheduleService"; // Import your schedule-related service function here
...
const EditSchedule = () => {
  ...
  const EditScheduleSubmit = async (e) => {
    e.preventDefault();
    console.log(data);
        ...
        >
          <div>
            ...
            <div className="container" style={{ width: "50%" }}>
              <form className="form-group" onSubmit={EditScheduleSubmit}>
